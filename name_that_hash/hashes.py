...
prototypes = [
    ...
    Prototype(
        regex=re.compile(r"^\$pkzip2?\$(1)\*[0-9]{1}\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,4}\*[0-9a-f]{1,4}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,3}\*(8)\*[0-9a-f]{1,4}(\*[0-9a-f]{1,4})?\*[0-9a-f]{1,4}\*[a-f0-9]+\*\$\/pkzip2?\$$", re.IGNORECASE),
        modes=[
            HashInfo(
    ...
    Prototype(
        regex=re.compile(r"^\$pkzip2?\$(1)\*[0-9]{1}\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,4}\*[0-9a-f]{1,4}\*[0-9a-f]{1,8}\*[0-9a-f]{1,8}\*[0-9a-f]{1,3}\*(0)\*[0-9a-f]{1,4}(\*[0-9a-f]{1,4})?\*[0-9a-f]{1,4}\*[a-f0-9]+\*\$\/pkzip2?\$$", re.IGNORECASE),
        modes=[
            HashInfo(
    ...
    Prototype(
        regex=re.compile(r"^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,4}\*[0-9a-f]{1,4}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]{1,16384})+\*(8)\*[0-9a-f]{1,4}(\*[0-9a-f]{1,4})?\*[0-9a-f]{1,4}\*[a-f0-9]+\*\$\/pkzip2?\$$", re.IGNORECASE),
        modes=[
            HashInfo(
    ...
    Prototype(
        regex=re.compile(r"^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,4}\*[0-9a-f]{1,4}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]{1,16384})+\*(0)\*[0-9a-f]{1,4}(\*[0-9a-f]{1,4})?\*[0-9a-f]{1,4}\*[a-f0-9]+\*\$\/pkzip2?\$$", re.IGNORECASE),
        modes=[
            HashInfo(
    ...
    Prototype(
        regex=re.compile(r"^\$pkzip2?\$([2-8])\*[0-9]{1}(\*[0-9]{1}\*[0-9a-f]{1,3}\*[0-9a-f]{1,4}\*[0-9a-f]{1,4}(\*[0-9a-f]{1,8})?\*[0-9a-f]{1,8}\*[0-9a-f]+)+\*\$\/pkzip2?\$$", re.IGNORECASE),
        modes=[
            HashInfo(
